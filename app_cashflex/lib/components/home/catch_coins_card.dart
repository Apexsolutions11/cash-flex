...
import '../../pages/catch_coin_page.dart';
import '../../utils/helper/jackpot_check_helper.dart';

class CatchCoinsCard extends StatelessWidget {
  const CatchCoinsCard({super.key});
        ...
        child: Container(
          ...
          child: Stack(
            ...
            children: [
              ...
              // Coin icon at bottom right - flush with corner
              Positioned(
                bottom: -8,
                right: -8,
                child: Opacity(
