...
import 'package:cashflex/pages/catch_coin_page.dart';
import '../../utils/helper/jackpot_check_helper.dart';

class TicTacToeCard extends StatelessWidget {
  const TicTacToeCard({super.key});
  ...
  Future<void> _navigateToGame(BuildContext context) async {
    ...
    if (context.mounted) {
      Navigator.of(
        context,
      ).push(MaterialPageRoute(builder: (context) => const CatchCoinsGamePage()));
    }
  }
        ...
        child: Container(
          ...
          child: Stack(
            ...
            children: [
              ...
              // Game image at bottom right - flush with corner
              Positioned(
                bottom: -8,
                right: -8,
                child: Image.asset(
