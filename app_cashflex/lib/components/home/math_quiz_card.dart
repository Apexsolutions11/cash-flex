...
import 'package:cashflex/pages/general_quiz_page.dart';
import '../../utils/helper/jackpot_check_helper.dart';

class MathQuizCard extends StatelessWidget {
  const MathQuizCard({super.key});
        ...
        child: Container(
          ...
          child: Stack(
            ...
            children: [
              ...
              // Math icon at bottom right - flush with corner
              Positioned(
                bottom: -8,
                right: -8,
                child: Icon(
